...
class FriendsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create friend' do
    assert_difference('Friend.count') do
      post friends_url,
           params: { friend: { first_name: 'UniqueFirstName', last_name: 'UniqueLastName', email: 'unique.email@example.com',
  ...
  test 'should update friend' do
    patch friend_url(@friend),
          params: { friend: { first_name: 'UpdatedFirstName', last_name: 'UpdatedLastName', email: 'updated.email@example.com',
